...
$(window).scroll(function() {
    if ($(this).scrollTop() > 100) {
        ...
        $('.logo-scrolled').removeClass('logo');

        $('.mobile-nav-toggle').addClass('mobile-nav-toggle-scrolled');
        $('.mobile-nav-toggle-scrolled').removeClass('mobile-nav-toggle');
    } else {
        $('#header').removeClass('header-scrolled');

        $('.logo-scrolled').addClass('logo');
        $('.logo').removeClass('logo-scrolled');

        $('.mobile-nav-toggle-scrolled').addClass('mobile-nav-toggle');
