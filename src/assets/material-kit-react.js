...
const primaryColor = "#279989";
const warningColor = "#ff9800";
const dangerColor = "#f44336";
const successColor = "#279989";
const infoColor = "#279989";
...
const infoCardHeader = {
    color: "#fff",
    background: "linear-gradient(90deg,#279989, #279989)",
    ...infoBoxShadow
};
const primaryCardHeader = {
    color: "#fff",
    background: "linear-gradient(60deg, #279989, #279989)",
    ...primaryBoxShadow
};
